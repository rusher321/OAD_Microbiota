...
ggsave("../result/Figure4/sfig6_pcor.positive.venn.pdf", p1, device = "pdf", width = 6, height = 6)
...
ggsave("../result/Figure4/sfig6_pcor.negative.venn.pdf", p2, device = "pdf", width = 6, height = 6)
