...
color_study <-  c("#1B9E77", "#66A61E", "#7570B3", "#1F78B4",  "#A6761D",
...
ggsave("../result/Sfig/sfig4b_all_prevspost.pcoa.pdf", plot = all, device = "pdf", width = 15, height = 6)
...
library(patchwork)
out <- p1+p2
ggsave(plot = out, filename = "../result/Sfig/sfig4c.pdf", device = "pdf", width = 10, height = 6)
...
ggsave(filename = "../result/Sfig/sFig4_left.pdf", plot = out, device = "pdf", width = 8, height = 8)
ggsave(filename = "../result/Sfig/sfig4_right.pdf", plot = test2, device = "pdf", width = 4, height = 6)
