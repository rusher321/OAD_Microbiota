...
pdf("../result/Sfig/sFig5b.diff_degree.pdf", width = 20, height = 5)
...
# sFig5c  generate the input of cytoscape

namelist <- names(outlist)[c(1,4,6)]
for(i in namelist){
  ...
  out_vertice <- paste0("../result/Sfig/", i, ".vertices.csv")
  ...
  out_edge <- paste0("../result/Sfig/", i, ".edges.csv")
